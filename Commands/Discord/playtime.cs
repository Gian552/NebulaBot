...
{
    public class Playtime : InteractionModuleBase<SocketInteractionContext>
    {
        [SlashCommand("playtime", "Zeigt deine Spielzeit auf dem SL Server an.")]
